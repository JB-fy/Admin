...
// 详情
func (dao *menuDao) Info(ctx context.Context, field []string, filter map[string]interface{}) (info gdb.Record) {
	joinCodeArr := []string{}
...
// 列表
func (dao *menuDao) List(ctx context.Context, field []string, filter map[string]interface{}) (list gdb.Result) {
	joinCodeArr := []string{}
