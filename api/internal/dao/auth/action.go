...
// 解析insert
func (dao *actionDao) ParseInsert(insert ...map[string]interface{}) func(m *gdb.Model) *gdb.Model {
...
// 解析update
func (dao *actionDao) ParseUpdate(update map[string]interface{}) func(m *gdb.Model) *gdb.Model {
	return func(m *gdb.Model) *gdb.Model {
