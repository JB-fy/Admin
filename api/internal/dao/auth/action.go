...
// 详情
func (dao *actionDao) Info(ctx context.Context, field []string, filter map[string]interface{}) (info gdb.Record) {
	joinCodeArr := []string{}
...
// 列表
func (dao *actionDao) List(ctx context.Context, field []string, filter map[string]interface{}) (list gdb.Result) {
	joinCodeArr := []string{}
