...
// 获取daoHandler
func (daoThis *roleRelOfPlatformAdminDao) HandlerCtx(ctx context.Context, dbOpt ...map[string]interface{}) *daoIndex.DaoHandler {
...
// 解析insert
func (daoThis *roleRelOfPlatformAdminDao) ParseInsert(insert map[string]interface{}, daoHandler *daoIndex.DaoHandler) gdb.ModelHandler {
...
// hook insert
func (daoThis *roleRelOfPlatformAdminDao) HookInsert(daoHandler *daoIndex.DaoHandler) gdb.HookHandler {
...
// 解析update
func (daoThis *roleRelOfPlatformAdminDao) ParseUpdate(update map[string]interface{}, daoHandler *daoIndex.DaoHandler) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
...
// hook update
func (daoThis *roleRelOfPlatformAdminDao) HookUpdate(daoHandler *daoIndex.DaoHandler) gdb.HookHandler {
	return gdb.HookHandler{
...
// hook delete
func (daoThis *roleRelOfPlatformAdminDao) HookDelete(daoHandler *daoIndex.DaoHandler) gdb.HookHandler {
	return gdb.HookHandler{
...
// 解析field
func (daoThis *roleRelOfPlatformAdminDao) ParseField(field []string, fieldWithParam map[string]interface{}, daoHandler *daoIndex.DaoHandler) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		for _, v := range field {
			switch v {
			/* case `xxxx`:
...
// hook select
func (daoThis *roleRelOfPlatformAdminDao) HookSelect(daoHandler *daoIndex.DaoHandler) gdb.HookHandler {
	return gdb.HookHandler{
...
// 解析filter
func (daoThis *roleRelOfPlatformAdminDao) ParseFilter(filter map[string]interface{}, daoHandler *daoIndex.DaoHandler) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
...
// 解析group
func (daoThis *roleRelOfPlatformAdminDao) ParseGroup(group []string, daoHandler *daoIndex.DaoHandler) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		for _, v := range group {
			switch v {
			case `id`:
...
// 解析order
func (daoThis *roleRelOfPlatformAdminDao) ParseOrder(order []string, daoHandler *daoIndex.DaoHandler) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		for _, v := range order {
			v = gstr.Trim(v)
			k := gstr.Split(v, ` `)[0]
...
// 解析join
func (daoThis *roleRelOfPlatformAdminDao) ParseJoin(joinTable string, daoHandler *daoIndex.DaoHandler) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
