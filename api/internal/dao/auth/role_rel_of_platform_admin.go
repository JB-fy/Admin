...
// 解析分库
func (daoThis *roleRelOfPlatformAdminDao) ParseDbGroup(ctx context.Context, dbGroupSeldata ...map[string]interface{}) string {
	group := daoThis.Group()
	// 分库逻辑
...
// 解析分表
func (daoThis *roleRelOfPlatformAdminDao) ParseDbTable(ctx context.Context, dbTableSelData ...map[string]interface{}) string {
	table := daoThis.Table()
	// 分表逻辑
...
// 解析insert
func (daoThis *roleRelOfPlatformAdminDao) ParseInsert(insert map[string]interface{}, fill ...bool) gdb.ModelHandler {
...
// hook insert
func (daoThis *roleRelOfPlatformAdminDao) HookInsert(data map[string]interface{}) gdb.HookHandler {
...
// 解析update
func (daoThis *roleRelOfPlatformAdminDao) ParseUpdate(update map[string]interface{}, fill ...bool) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
...
// hook update
func (daoThis *roleRelOfPlatformAdminDao) HookUpdate(data map[string]interface{}, idArr ...int) gdb.HookHandler {
	return gdb.HookHandler{
...
// hook delete
func (daoThis *roleRelOfPlatformAdminDao) HookDelete(idArr ...int) gdb.HookHandler {
	return gdb.HookHandler{
...
// 解析field
func (daoThis *roleRelOfPlatformAdminDao) ParseField(field []string, fieldWithParam map[string]interface{}, afterField *[]string, afterFieldWithParam map[string]interface{}, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		for _, v := range field {
			switch v {
			/* case `xxxx`:
...
// hook select
func (daoThis *roleRelOfPlatformAdminDao) HookSelect(afterField *[]string, afterFieldWithParam map[string]interface{}) gdb.HookHandler {
	return gdb.HookHandler{
...
// 解析filter
func (daoThis *roleRelOfPlatformAdminDao) ParseFilter(filter map[string]interface{}, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
...
// 解析group
func (daoThis *roleRelOfPlatformAdminDao) ParseGroup(group []string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		for _, v := range group {
			switch v {
			case `id`:
...
// 解析order
func (daoThis *roleRelOfPlatformAdminDao) ParseOrder(order []string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		for _, v := range order {
...
// 解析join
func (daoThis *roleRelOfPlatformAdminDao) ParseJoin(joinCode string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		switch joinCode {
		/* case Xxxx.Table():
		relTable := Xxxx.Table()
