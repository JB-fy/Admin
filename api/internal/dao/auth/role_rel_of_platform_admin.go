...
// 解析insert
func (daoThis *roleRelOfPlatformAdminDao) ParseInsert(insert map[string]interface{}) gdb.ModelHandler {
...
// 解析update
func (daoThis *roleRelOfPlatformAdminDao) ParseUpdate(update map[string]interface{}) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
...
// hook update
func (daoThis *roleRelOfPlatformAdminDao) HookUpdate(data map[string]interface{}, idArr ...uint) gdb.HookHandler {
	return gdb.HookHandler{
...
// hook delete
func (daoThis *roleRelOfPlatformAdminDao) HookDelete(idArr ...uint) gdb.HookHandler {
	return gdb.HookHandler{
