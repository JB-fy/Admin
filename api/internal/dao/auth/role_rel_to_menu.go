...
// 解析insert
func (dao *roleRelToMenuDao) ParseInsert(insert ...map[string]interface{}) func(m *gdb.Model) *gdb.Model {
...
// 解析update
func (dao *roleRelToMenuDao) ParseUpdate(update map[string]interface{}) func(m *gdb.Model) *gdb.Model {
	return func(m *gdb.Model) *gdb.Model {
