...
// hook update
func (daoThis *roleRelToMenuDao) HookUpdate(data map[string]interface{}, idArr ...uint) gdb.HookHandler {
	return gdb.HookHandler{
...
// hook delete
func (daoThis *roleRelToMenuDao) HookDelete(idArr ...uint) gdb.HookHandler {
	return gdb.HookHandler{
