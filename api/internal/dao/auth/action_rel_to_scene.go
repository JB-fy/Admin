...
// 解析分库
func (daoThis *actionRelToSceneDao) ParseDbGroup(ctx context.Context, dbGroupSeldata ...map[string]interface{}) string {
	group := daoThis.Group()
	// 分库逻辑
...
// 解析分表
func (daoThis *actionRelToSceneDao) ParseDbTable(ctx context.Context, dbTableSelData ...map[string]interface{}) string {
	table := daoThis.Table()
	// 分表逻辑
...
// hook insert
func (daoThis *actionRelToSceneDao) HookInsert(data map[string]interface{}) gdb.HookHandler {
...
// 解析field
func (daoThis *actionRelToSceneDao) ParseField(field []string, joinTableArr *[]string, fieldWithParam ...map[string]interface{}) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		afterField := []string{}
		for _, v := range field {
			switch v {
...
// hook select
func (daoThis *actionRelToSceneDao) HookSelect(afterField []string, afterFieldWithParam ...map[string]interface{}) gdb.HookHandler {
	return gdb.HookHandler{
...
// 解析order
func (daoThis *actionRelToSceneDao) ParseOrder(order []string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		for _, v := range order {
