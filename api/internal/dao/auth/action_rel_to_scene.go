...
// 解析insert
func (dao *actionRelToSceneDao) ParseInsert(insert []map[string]interface{}, fill ...bool) func(m *gdb.Model) *gdb.Model {
...
// 解析update
func (dao *actionRelToSceneDao) ParseUpdate(update map[string]interface{}, fill ...bool) func(m *gdb.Model) *gdb.Model {
	return func(m *gdb.Model) *gdb.Model {
...
// 获取数据后，再处理的字段
func (dao *actionRelToSceneDao) afterField(info map[string]interface{}, afterField []string) {
