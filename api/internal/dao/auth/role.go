...
// 解析insert
func (dao *roleDao) ParseInsert(insert ...map[string]interface{}) func(m *gdb.Model) *gdb.Model {
...
// 解析update
func (dao *roleDao) ParseUpdate(update map[string]interface{}) func(m *gdb.Model) *gdb.Model {
	return func(m *gdb.Model) *gdb.Model {
