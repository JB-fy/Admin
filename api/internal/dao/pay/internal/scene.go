...
// SceneDao is the data access object for the table pay_scene.
...
// SceneColumns defines and stores column names for the table pay_scene.
...
// sceneColumns holds the columns for the table pay_scene.
