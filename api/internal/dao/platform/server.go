...
// 解析分库
func (daoThis *serverDao) ParseDbGroup(ctx context.Context, dbGroupSelData ...map[string]interface{}) string {
	group := daoThis.Group()
	// 分库逻辑
...
// 解析分表
func (daoThis *serverDao) ParseDbTable(ctx context.Context, dbTableSelData ...map[string]interface{}) string {
	table := daoThis.Table()
	// 分表逻辑
...
// 解析insert
func (daoThis *serverDao) ParseInsert(insert map[string]interface{}) gdb.ModelHandler {
...
// hook insert
func (daoThis *serverDao) HookInsert(data map[string]interface{}) gdb.HookHandler {
...
// 解析update
func (daoThis *serverDao) ParseUpdate(update map[string]interface{}) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
...
// hook update
func (daoThis *serverDao) HookUpdate(data map[string]interface{}, idArr ...uint) gdb.HookHandler {
	return gdb.HookHandler{
...
// hook delete
func (daoThis *serverDao) HookDelete(idArr ...uint) gdb.HookHandler {
	return gdb.HookHandler{
...
// 解析field
func (daoThis *serverDao) ParseField(field []string, fieldWithParam map[string]interface{}, afterField *[]string, afterFieldWithParam map[string]interface{}, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
		tableThis := daoThis.ParseDbTable(ctx)
		for _, v := range field {
...
// hook select
func (daoThis *serverDao) HookSelect(afterField *[]string, afterFieldWithParam map[string]interface{}) gdb.HookHandler {
	return gdb.HookHandler{
...
// 解析order
func (daoThis *serverDao) ParseOrder(order []string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
		tableThis := daoThis.ParseDbTable(ctx)
		for _, v := range order {
