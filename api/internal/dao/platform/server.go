...
// 解析分库
func (daoThis *serverDao) ParseDbGroup(dbGroupSeldata map[string]interface{}) string {
	group := daoThis.Group()
...
// 解析分表
func (daoThis *serverDao) ParseDbTable(dbTableSelData map[string]interface{}) string {
	table := daoThis.Table()
