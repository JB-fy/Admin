...
// 解析insert
func (dao *adminDao) ParseInsert(insert ...map[string]interface{}) func(m *gdb.Model) *gdb.Model {
...
// 解析update
func (dao *adminDao) ParseUpdate(update map[string]interface{}) func(m *gdb.Model) *gdb.Model {
	return func(m *gdb.Model) *gdb.Model {
