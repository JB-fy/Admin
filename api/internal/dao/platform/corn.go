...
// internalCornDao is internal type for wrapping internal DAO implements.
type internalCornDao = *internal.CornDao
...
var (
	// Corn is globally public accessible object for table platform_corn operations.
	Corn = cornDao{
		internal.NewCornDao(),
	}
)
...
// 解析分库
func (daoThis *cornDao) ParseDbGroup(dbGroupSeldata map[string]interface{}) string {
	group := daoThis.Group()
...
// 解析分表
func (daoThis *cornDao) ParseDbTable(dbTableSelData map[string]interface{}) string {
	table := daoThis.Table()
...
// 解析分库分表（对外暴露使用）
func (daoThis *cornDao) ParseDbCtx(ctx context.Context, dbSelDataList ...map[string]interface{}) *gdb.Model {
...
// 解析insert
func (daoThis *cornDao) ParseInsert(insert map[string]interface{}, fill ...bool) gdb.ModelHandler {
...
// hook insert
func (daoThis *cornDao) HookInsert(data map[string]interface{}) gdb.HookHandler {
...
// 解析update
func (daoThis *cornDao) ParseUpdate(update map[string]interface{}, fill ...bool) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
...
// hook update
func (daoThis *cornDao) HookUpdate(data map[string]interface{}, idArr ...int) gdb.HookHandler {
	return gdb.HookHandler{
...
// hook delete
func (daoThis *cornDao) HookDelete(idArr ...int) gdb.HookHandler {
	return gdb.HookHandler{
...
// 解析field
func (daoThis *cornDao) ParseField(field []string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		afterField := []string{}
		for _, v := range field {
			switch v {
...
// hook select
func (daoThis *cornDao) HookSelect(afterField []string) gdb.HookHandler {
	return gdb.HookHandler{
...
// 解析filter
func (daoThis *cornDao) ParseFilter(filter map[string]interface{}, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
...
// 解析group
func (daoThis *cornDao) ParseGroup(group []string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		for _, v := range group {
			switch v {
			case `id`:
...
// 解析order
func (daoThis *cornDao) ParseOrder(order []string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		for _, v := range order {
...
// 解析join
func (daoThis *cornDao) ParseJoin(joinCode string, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		switch joinCode {
		/* case Xxxx.Table():
		relTable := Xxxx.Table()
