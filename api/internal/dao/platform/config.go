...
// 解析insert
func (daoThis *configDao) ParseInsert(insert map[string]interface{}) gdb.ModelHandler {
...
// 解析update
func (daoThis *configDao) ParseUpdate(update map[string]interface{}) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
...
// hook update
func (daoThis *configDao) HookUpdate(data map[string]interface{}, idArr ...uint) gdb.HookHandler {
	return gdb.HookHandler{
...
// hook delete
func (daoThis *configDao) HookDelete(idArr ...uint) gdb.HookHandler {
	return gdb.HookHandler{
...
// 解析field
func (daoThis *configDao) ParseField(field []string, fieldWithParam map[string]interface{}, afterField *[]string, afterFieldWithParam map[string]interface{}, joinTableArr *[]string) gdb.ModelHandler {
	return func(m *gdb.Model) *gdb.Model {
		ctx := m.GetCtx()
		tableThis := daoThis.ParseDbTable(ctx)
		for _, v := range field {
...
// hook select
func (daoThis *configDao) HookSelect(afterField *[]string, afterFieldWithParam map[string]interface{}) gdb.HookHandler {
	return gdb.HookHandler{
...
func (daoThis *configDao) Save(ctx context.Context, config map[string]interface{}) (err error) {
	err = daoThis.ParseDbCtx(ctx).Transaction(ctx, func(ctx context.Context, tx gdb.TX) (err error) {
		for k, v := range config {
			_, err = tx.Model(daoThis.ParseDbTable(ctx)).Data(g.Map{daoThis.Columns().ConfigKey: k, daoThis.Columns().ConfigValue: v}).Save()
			if err != nil {
				return
			}
		}
