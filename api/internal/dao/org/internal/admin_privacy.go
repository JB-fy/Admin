...
// AdminPrivacyColumns defines and stores column names for the table org_admin_privacy.
...
// adminPrivacyColumns holds the columns for the table org_admin_privacy.
