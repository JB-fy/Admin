...
const (
	...
	TypeNameImageSuffix    MyGenFieldTypeName = `命名：icon,cover,avatar,img,img_list,imgList,img_arr,imgArr,image,image_list,imageList,image_arr,imageArr等后缀；	类型：varchar或json或text`
	TypeNameVideoSuffix    MyGenFieldTypeName = `命名：video,video_list,videoList,video_arr,videoArr等后缀；	类型：varchar或json或text`
	TypeNameAudioSuffix    MyGenFieldTypeName = `命名：audio,audio_list,audioList,audio_arr,audioArr等后缀；	类型：varchar或json或text`
	TypeNameFileSuffix     MyGenFieldTypeName = `命名：file,file_list,fileList,file_arr,fileArr等后缀；	类型：varchar或json或text`
	TypeNameArrSuffix      MyGenFieldTypeName = `命名：list,arr等后缀；	类型：varchar或json或text；`
)
