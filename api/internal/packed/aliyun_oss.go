...
func (aliyunOssThis *AliyunOss) Notify(r *ghttp.Request) (err error) {
	...
	if strAuthorizationBase64 == "" {
		err = utils.NewErrorCode(aliyunOssThis.Ctx, 40000000, err.Error())
		return
	}
	publicKeyURLBase64 := r.Header.Get("x-oss-pub-key-url")
	if publicKeyURLBase64 == "" {
		err = utils.NewErrorCode(aliyunOssThis.Ctx, 40000001, "")
		return
	}
	...
	if err != nil {
		err = utils.NewErrorCode(aliyunOssThis.Ctx, 40000002, err.Error())
		return
	}
	...
	r.Body.Close()
	if err != nil {
		err = utils.NewErrorCode(aliyunOssThis.Ctx, 40000003, err.Error())
		return
	}
	...
	if pubBlock == nil {
		err = utils.NewErrorCode(aliyunOssThis.Ctx, 40000003, "")
		return
	}
	...
	if errorVerifyPKCS1v15 != nil {
		err = utils.NewErrorCode(aliyunOssThis.Ctx, 40000003, errorVerifyPKCS1v15.Error())
		return
	}
	return
}
