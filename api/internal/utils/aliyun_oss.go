...
// 创建签名（web前端直传用）
func (this *AliyunOss) createSign(claims CustomClaims) (tokenString string, err error) {

	return
}

// 解析 token
func (this *AliyunOss) ParseToken(tokenString string) (claims *CustomClaims, err error) {
