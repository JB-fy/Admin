...
type SceneListReq struct {
	g.Meta `path:"/list" method:"post" tags:"平台后台/场景" sm:"列表"`
...
type SceneInfoReq struct {
	g.Meta `path:"/info" method:"post" tags:"平台后台/场景" sm:"详情"`
...
type SceneCreateReq struct {
	g.Meta      `path:"/create" method:"post" tags:"平台后台/场景" sm:"创建"`
...
type SceneUpdateReq struct {
	g.Meta      `path:"/update" method:"post" tags:"平台后台/场景" sm:"更新"`
...
type SceneDeleteReq struct {
	g.Meta `path:"/del" method:"post" tags:"平台后台/场景" sm:"删除"`
	IdArr  []uint `c:"idArr,omitempty" json:"idArr" v:"required|distinct|foreach|integer|foreach|min:1" dc:"ID数组"`
}
