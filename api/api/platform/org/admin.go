...
type AdminListReq struct {
	g.Meta `path:"/admin/list" method:"post" tags:"平台后台/权限管理/机构管理员" sm:"列表"`
...
type AdminInfoReq struct {
	g.Meta `path:"/admin/info" method:"post" tags:"平台后台/权限管理/机构管理员" sm:"详情"`
	Field  []string `json:"field" v:"distinct|foreach|min-length:1" dc:"查询字段，传值参考返回的字段名，默认返回常用字段，如果所需字段较少或需特别字段时，可使用。特别注意：所需字段较少时使用，可大幅减轻数据库压力"`
...
type AdminUpdateReq struct {
	g.Meta   `path:"/admin/update" method:"post" tags:"平台后台/权限管理/机构管理员" sm:"修改"`
	...
	OrgId    *uint   `json:"org_id,omitempty" filter:"-" v:"between:0,4294967295" dc:"机构ID"`
	...
	// IsSuper   *uint   `json:"is_super,omitempty" filter:"-" v:"in:0,1" dc:"超管：0否 1是"`
	RoleIdArr *[]uint `json:"role_id_arr,omitempty" filter:"-" v:"distinct|foreach|between:1,4294967295" dc:"角色ID"`
...
type AdminDeleteReq struct {
	g.Meta `path:"/admin/del" method:"post" tags:"平台后台/权限管理/机构管理员" sm:"删除"`
