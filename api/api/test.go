...
type TestReq struct {
	...
	// Filter TestFilter `json:"filter" d:"{\"time_range_start\": \"2006-01-02 15:04:05\"}" dc:"过滤条件"`	//多层结构体嵌套很影响性能，并发减少很多
	/* Filter struct {
		FilterTimeRangeStart *gtime.Time `json:"time_range_start,omitempty" v:"date-format:Y-m-d H:i:s" dc:"开始时间：YYYY-mm-dd HH:ii:ss"`
	} `json:"where" dc:"查询条件"` */
}
...
type TestInfo struct {
	...
	TestId *uint   `json:"test_id,omitempty" dc:"测试ID"`
}
