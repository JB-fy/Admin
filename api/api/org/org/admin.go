...
type AdminListReq struct {
	g.Meta `path:"/admin/list" method:"post" tags:"机构后台/权限管理/机构管理员" sm:"列表"`
...
type AdminInfoReq struct {
	g.Meta `path:"/admin/info" method:"post" tags:"机构后台/权限管理/机构管理员" sm:"详情"`
	Field  []string `json:"field" v:"distinct|foreach|min-length:1" dc:"查询字段，传值参考返回的字段名，默认返回常用字段，如果所需字段较少或需特别字段时，可使用。特别注意：所需字段较少时使用，可大幅减轻数据库压力"`
...
type AdminCreateReq struct {
	g.Meta    `path:"/admin/create" method:"post" tags:"机构后台/权限管理/机构管理员" sm:"新增"`
...
type AdminUpdateReq struct {
	g.Meta    `path:"/admin/update" method:"post" tags:"机构后台/权限管理/机构管理员" sm:"修改"`
...
type AdminDeleteReq struct {
	g.Meta `path:"/admin/del" method:"post" tags:"机构后台/权限管理/机构管理员" sm:"删除"`
	IdArr  []uint `json:"id_arr,omitempty" v:"required|distinct|foreach|between:1,4294967295" dc:"ID数组"`
}
