...
const table = reactive({
    columns: [
        ...
        {
            dataKey: 'scene_name',
            title: t('auth.scene.name.scene_name'),
            key: 'scene_name',
            align: 'center',
            width: 150,
            cellRenderer: (props: any): any => {
        ...
        {
            dataKey: 'remark',
            title: t('auth.scene.name.remark'),
            key: 'remark',
            align: 'center',
            width: 200,
            hidden: true,
        ...
        {
            dataKey: 'is_stop',
            title: t('auth.scene.name.is_stop'),
            key: 'is_stop',
            align: 'center',
            width: 100,
            cellRenderer: (props: any): any => {
    ...
    <el-row class="main-table-tool">
        ...
        <el-col :span="8" style="text-align: right">
            <el-space :size="10" style="height: 100%; margin-right: 10px">
                <my-export-button i18nPrefix="auth.scene" :headerList="table.columns" :api="{ code: t('config.VITE_HTTP_API_PREFIX') + '/auth/scene/list', param: { filter: queryCommon.data, sort: table.sort.key + ' ' + table.sort.order } }" />
