        ...
        },
        {
            ...
            cellRenderer: (props: any): any => {
                if (!authAction.isUpdate) {
                    return [
                        <el-text line-clamp="2" title={props.rowData.action_name}>
                ...
                if (!props.rowData?.editActionName?.isEdit) {
                    return [
                        <el-text class="inline-edit" type="primary" line-clamp="2" title={props.rowData.action_name} onClick={() => (props.rowData.editActionName = { isEdit: true, oldValue: props.rowData.action_name })}>
                            {props.rowData.action_name}
                        </el-text>,
                    ]
                }
                ...
                return [
                    <el-input
                        ...
                        onBlur={() => {
                            ...
                            handleUpdate(props.rowData.id, { action_name: props.rowData.action_name }).catch(() => (props.rowData.action_name = props.rowData.editActionName.oldValue))
                        }}
    ...
    ElMessageBox.confirm('', {
        ...
        beforeClose: (action: Action, instance: MessageBoxState, done: Function) => {
            if (action == 'confirm') {
                ...
                request(t('config.VITE_HTTP_API_PREFIX') + '/auth/action/del', { [Array.isArray(id) ? 'id_arr' : 'id']: id }, true)
