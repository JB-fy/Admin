...
const authAction: { [propName: string]: boolean } = {
    isRead: adminStore.isAction('appPkgRead'),
    isCreate: adminStore.isAction('appPkgCreate'),
    isUpdate: adminStore.isAction('appPkgUpdate'),
    isDelete: adminStore.isAction('appPkgDelete'),
}
