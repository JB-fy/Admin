                ...
                return [
                    <el-input
                        ...
                        onBlur={() => {
                            ...
                            handleUpdate({ id_arr: [props.rowData.id], package_name: props.rowData.package_name }).catch(() => (props.rowData.package_name = props.rowData.editPackageName.oldValue))
                        }}
                        onKeydown={(event: any) => {
                ...
                return [
                    <el-input-number
                        ...
                        onBlur={() => {
                            ...
                            handleUpdate({ id_arr: [props.rowData.id], ver_no: props.rowData.ver_no }).catch(() => (props.rowData.ver_no = props.rowData.editVerNo.oldValue))
                        }}
                        onKeydown={(event: any) => {
                            switch (event.keyCode) {
                                case 13: //13：Enter键 27：Esc键 32：空格键
                ...
                return [
                    <el-input
                        ...
                        onBlur={() => {
                            ...
                            handleUpdate({ id_arr: [props.rowData.id], ver_name: props.rowData.ver_name }).catch(() => (props.rowData.ver_name = props.rowData.editVerName.oldValue))
                        }}
                        onKeydown={(event: any) => {
                            switch (event.keyCode) {
                                case 13: //13：Enter键 27：Esc键 32：空格键
            ...
            cellRenderer: (props: any): any => {
                return [
                    <el-switch
                        ...
                        onChange={(val: number) => handleUpdate({ id_arr: [props.rowData.id], is_force_prev: val }).then(() => (props.rowData.is_force_prev = val))}
...
const handleDelete = (idArr: number[]) => {
    ElMessageBox.confirm('', {
        ...
        center: true,
        showClose: false,
    }).then(() => request(t('config.VITE_HTTP_API_PREFIX') + '/app/app/del', { id_arr: idArr }, true).then(() => getList()))
}
//更新
