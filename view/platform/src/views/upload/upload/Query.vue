...
<template>
    <el-form class="query-form" :ref="(el: any) => queryForm.ref = el" :model="queryCommon.data" :inline="true" @keyup.enter="queryForm.submit">
        ...
        <el-form-item prop="upload_type">
            <el-select-v2 v-model="queryCommon.data.upload_type" :options="tm('upload.upload.status.upload_type')" :placeholder="t('upload.upload.name.upload_type')" :clearable="true" style="width: 128px" />
        </el-form-item>
