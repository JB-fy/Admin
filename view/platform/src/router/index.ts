...
const initRouteList = [
    {
        ...
        children: [
            ...
            },
            {
                path: '/app/pkg',
                component: async () => {
                    const component = await import('@/views/app/pkg/Index.vue')
                    component.default.name = '/app/pkg'
                    return component
                },
                meta: { isAuth: true, keepAlive: true, componentName: '/app/pkg' },
            },
            {
                path: '/users/users',
                component: async () => {
            ...
            {
                path: '/thirdSite', //必须带query.url参数。示例：/thirdSite?url=https://element-plus.org/zh-CN/
