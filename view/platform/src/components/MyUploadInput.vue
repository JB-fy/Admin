...
<template>
    <div v-if="props.isShowInput" style="width: 100%">
        <el-checkbox v-model="upload.isInput" label="手动填写地址" />
    </div>
    <template v-if="upload.isInput">
        <el-input v-model="(model as any)" v-bind="$attrs">
