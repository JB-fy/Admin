...
const authAction: { [propName: string]: boolean } = {
    isRead: adminStore.isAction('adminRead'),
    isCreate: adminStore.isAction('adminCreate'),
    isUpdate: adminStore.isAction('adminUpdate'),
    isDelete: adminStore.isAction('adminDelete'),
}
