...
.menu-tabs ::v-deep .el-tabs__header {
    margin-bottom: 0;
    border: none;
}

.menu-tabs ::v-deep .el-tabs__nav {
    border: none;
}

.menu-tabs ::v-deep .el-tabs__item:last-child {
    margin-right: 0;
}

.menu-tabs ::v-deep .el-tabs__nav-prev,
.menu-tabs ::v-deep .el-tabs__nav-next,
.menu-tabs ::v-deep .el-tabs__item {
    height: 40px;
    line-height: 40px;
}
...
.menu-tabs ::v-deep .el-tabs__item.is-active {
...
.menu-tabs ::v-deep .el-tabs__item:not(.is-active):hover {
...
.menu-tabs ::v-deep .el-tabs__item:not(.is-active) .is-icon-close {
    margin-left: 0;
}

.menu-tabs ::v-deep .el-tabs__item:not(.is-active):hover .is-icon-close {
    margin-left: 5px;
}
</style>