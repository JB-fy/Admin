...
const table = reactive({
    ...
    {
        dataKey: 'requestUrl',
        title: t('view.log.request.name.requestUrl'),
        key: 'requestUrl',
        width: 300,
        align: 'center',
    },
    {
        ...
        title: t('view.log.request.name.requestHeader'),
        key: 'requestHeader',
        width: 200,
        align: 'center',
    },
    {
        dataKey: 'requestData',
        title: t('view.log.request.name.requestData'),
        key: 'requestData',
        width: 200,
        align: 'center',
    },
    {
        ...
        title: t('view.log.request.name.responseBody'),
        key: 'responseBody',
        width: 200,
        align: 'center',
    },
    {
        dataKey: 'runTime',
        title: t('view.log.request.name.runTime'),
        key: 'runTime',
        align: 'center',
        width: 150,
        sortable: true,
