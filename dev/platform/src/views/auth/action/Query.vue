...
<template>
    <ElForm class="query-form" :ref="(el: any) => { queryForm.ref = el }" :model="queryCommon.data" :inline="true"
        ...
        <ElFormItem prop="actionName">
            <ElInput v-model="queryCommon.data.actionName" :placeholder="t('auth.action.name.actionName')"
                :clearable="true" />
        </ElFormItem>
        <ElFormItem prop="actionCode">
            <ElInput v-model="queryCommon.data.actionCode" :placeholder="t('auth.action.name.actionCode')"
                :clearable="true" />
        </ElFormItem>
        <ElFormItem prop="sceneId">
            <MySelect v-model="queryCommon.data.sceneId" :placeholder="t('auth.action.name.sceneId')"
        ...
        <ElFormItem prop="isStop" style="width: 100px;">
            <ElSelectV2 v-model="queryCommon.data.isStop" :options="tm('common.status.whether')"
                :placeholder="t('auth.action.name.isStop')" :clearable="true" />
        </ElFormItem>
        <ElFormItem>
