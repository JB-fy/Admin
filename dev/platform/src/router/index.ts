...
const initRouteList = [
    {
        ...
        children: [
            ...
            },
            {
                path: '/platform/cron',
                component: async () => {
                    const component = await import('@/views/platform/cron/Index.vue')
                    component.default.name = '/platform/cron'
                    return component
                },
                meta: { isAuth: true, keepAlive: true, componentName: '/platform/cron' }
            },
