...
机构后台生成示例：
	...
	./main myGen -dbGroup=default -dbTable=org_admin -removePrefixCommon= -removePrefixAlone=org_ -isApi=1 -isResetLogic=1 -isAuthAction=1 -commonName=权限管理/管理员 -isView=1 -sceneCode=org -isList=1 -isCount=1 -isInfo=1 -isCreate=1 -isUpdate=1 -isDelete=1

APP生成示例：
	./main myGen -dbGroup=default -dbTable=users -removePrefixCommon= -removePrefixAlone= -isApi=1 -isResetLogic=1 -isAuthAction=0 -commonName=用户 -isView=0 -sceneCode=app -isList=1 -isCount=0 -isInfo=1 -isCreate=0 -isUpdate=0 -isDelete=0
```
